...
struct SqrtFunctor
{
    ...
    {
        using Coord =
            typename T_OuterCoord::template Cat< T_InnerCoord >;
...
int main(int argc,char * * argv)
{
    ...
    using Mapping = llama::mapping::SoA<
        ...
        Particle
    >;
    using MiniMapping = llama::mapping::SoA<
        UD,
        Particle
    >;
        ...
        for (std::size_t y = 0; y < iterations[1]; ++y)
        {
            ...
            auto miniView = llama::Factory<
                ...
                llama::allocator::Stack<
                    miniSize[0] * miniSize[1] * llama::SizeOf< Particle >::value
                >
