...
namespace llama
{
    /** Helper class just holding some numbers at compile time. A similar
     * sequence is part of the STL starting with C++14, but as LLAMA supports
     * down to C++11 an own implementation is needed \tparam T_seg... variadic
    ...
    namespace internal
    {
        template<std::size_t T_FirstVal, std::size_t... T_vals>
        ...
        struct IntegerSequenceHelper<0, T_vals...>
        {
    ...
    using MakeIntegerSequence =
        typename internal::IntegerSequenceHelper<T_N - 1>::type;
