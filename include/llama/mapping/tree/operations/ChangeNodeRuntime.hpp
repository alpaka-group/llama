...
{
    return internal::ChangeNodeRuntime<
        T_Tree,
        T_TreeCoord
    >()(
        tree,
...
struct ChangeNodeChildsRuntimeFunctor
{
    ...
    -> decltype(
        OperatorSpecialization< T_Element >()(
            newValue,
            element
        )
    )
...
-> decltype(
    internal::ChangeNodeChildsRuntime<
        T_Tree,
        T_Operation,
        T_TreeCoord
    >()(
