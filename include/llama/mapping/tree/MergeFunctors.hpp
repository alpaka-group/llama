        ...
        namespace tree
        {
            namespace internal
            {
                ...
                struct MergeFunctorsImpl
                {
                    ...
                    decltype(operation.basicToResult(T_Tree()))
                        const treeAfterOp;
                    ...
                    LLAMA_FN_HOST_ACC_INLINE auto basicCoordToResultCoord(
                        ...
                        -> decltype(
                            subMergeFunctorsImpl.basicCoordToResultCoord(
                                operation
                                    .basicCoordToResultCoord(basicCoord, tree),
                                treeAfterOp))
                    {
                    ...
                    LLAMA_FN_HOST_ACC_INLINE auto resultCoordToBasicCoord(
                        ...
                        -> decltype(
                            subMergeFunctorsImpl.resultCoordToBasicCoord(
                                operation
                                    .resultCoordToBasicCoord(resultCoord, tree),
                ...
                struct MergeFunctorsImpl<T_Tree, Tuple<T_LastOperation>>
                {
                    ...
                    LLAMA_FN_HOST_ACC_INLINE auto resultCoordToBasicCoord(
                        T_TreeCoord const & resultCoord,
                        T_Tree const & tree) const
                        -> decltype(operation.resultCoordToBasicCoord(
                            resultCoord,
                            tree))
                    {
            ...
            {
                using MergeFunctorsImpl = typename internal::
                    MergeFunctorsImpl<T_Tree, T_TreeOperationList>;
